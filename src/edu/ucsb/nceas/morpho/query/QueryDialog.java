...
public class QueryDialog extends javax.swing.JDialog
{
  ...
  */
  Vector textPanels;
	...
	public QueryDialog(Frame parent)
	{
		super(parent);
		...
		SubjectTextPanel.setBounds(2,24,713,285);
		...
		Query.setBounds(0,0,710,196);
		QueryChoicesPanel.setAlignmentX(0.0F);
		SubjectTextControlsPanel.setLayout(new GridLayout(2,1,0,0));
		SubjectTextPanel.add(BorderLayout.SOUTH,SubjectTextControlsPanel);
		MoreLessControlsPanel.setLayout(new FlowLayout(FlowLayout.LEFT,5,5));
		SubjectTextControlsPanel.add(MoreLessControlsPanel);
		...
		ExecuteControlsPanel.setLayout(new FlowLayout(FlowLayout.CENTER,5,5));
		SubjectTextControlsPanel.add(ExecuteControlsPanel);
		...
		ExecuteControlsPanel.add(OtherTabsCheckBox);
		SearchChoicePanel.setLayout(new FlowLayout(FlowLayout.CENTER,5,5));
		ExecuteControlsPanel.add(SearchChoicePanel);
		...
		//}}
		ExecuteControlsPanel.setBorder(
	...
	javax.swing.JPanel ExecuteControlsPanel = new javax.swing.JPanel();
