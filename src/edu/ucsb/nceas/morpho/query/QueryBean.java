...
public class QueryBean extends Container implements PluginInterface
{
  ...
  com.symantec.itools.javax.swing.models.StringListModel DocTypeListModel =
    new com.symantec.itools.javax.swing.models.StringListModel();
  com.symantec.itools.javax.swing.models.StringComboBoxModel MatchTypesModel =
    new com.symantec.itools.javax.swing.models.StringComboBoxModel();
  com.symantec.itools.javax.swing.models.
    StringComboBoxModel MatchTypesModel2 =
    new com.symantec.itools.javax.swing.models.StringComboBoxModel();
  com.symantec.itools.javax.swing.models.
    StringComboBoxModel MatchTypesModel3 =
    new com.symantec.itools.javax.swing.models.StringComboBoxModel();
  com.symantec.itools.javax.swing.models.
    StringComboBoxModel MatchTypesModel4 =
    new com.symantec.itools.javax.swing.models.StringComboBoxModel();
  com.symantec.itools.javax.swing.models.
    StringComboBoxModel MatchTypesModel5 =
    new com.symantec.itools.javax.swing.models.StringComboBoxModel();
  com.symantec.itools.javax.swing.models.
    StringComboBoxModel MatchTypesModel6 =
    new com.symantec.itools.javax.swing.models.StringComboBoxModel();
  com.symantec.itools.javax.swing.models.StringTreeModel eml_dataset =
    new com.symantec.itools.javax.swing.models.StringTreeModel();
  com.symantec.itools.javax.swing.models.StringTreeModel eml_access =
    new com.symantec.itools.javax.swing.models.StringTreeModel();
  com.symantec.itools.javax.swing.borders.EtchedBorder etchedBorder1 =
    new com.symantec.itools.javax.swing.borders.EtchedBorder();
  //}}
...
*/
  ...
  {
    // on the Mac, popups are triggered on mouse pressed, 
    // while mouseReleased triggers them
    // on the PC; use the trigger flag to record a trigger, 
    // but do not show popup until the mouse released event
    ...
    private void maybeShowPopup(MouseEvent e)
    {
      ...
      int selrow =
        ((JTable) e.getComponent()).rowAtPoint(new Point(e.getX(), e.getY()));
  ...
  {
    if (AndButton2.isSelected())
      OrButton2.setSelected(false);
  }

  void OrButton2_itemStateChanged(java.awt.event.ItemEvent event)
  {
    if (OrButton2.isSelected())
      AndButton2.setSelected(false);
  }
  ...
  void MoreButton_actionPerformed(java.awt.event.ActionEvent event)
  {
    ...
    else if (TextChoices4.isVisible())
      TextChoices5.setVisible(true);
    else if (TextChoices3.isVisible())
      TextChoices4.setVisible(true);
    else if (TextChoices2.isVisible())
      TextChoices3.setVisible(true);
    ...
    if (searchlocal)
    {
      ...
      else
      {
        ...
        if (TextValue1.getText().length() > 0)
        {
          ...
          if ((TextChoices4.isVisible())
              && (TextValue4.getText().length() > 0))
          {
            mode = TextMatch4.getSelectedItem().toString();
            match = TextValue4.getText();
            paths[3] = getPath(mode, match);
          }
          if ((TextChoices5.isVisible())
              && (TextValue5.getText().length() > 0))
          {
          ...
          if (paths[5].length() > 0)
            paths[5] = "//*[" + paths[5] + "]";
          QueryStringTextArea1.setText("Query generated on:" +
                                       new Date().toString());
          boolean op1 = true;
    ...
    if (searchlocal)
    {
      ...
      else
      {
        ...
        if (TextValue11.getText().length() > 0)
        {
          ...
          {
            paths[0] =
              "//title[contains(text(),\"" + TextValue11.getText() + "\")]";
          }
          if (AbstractCheckBox.isSelected())
          {
            paths[1] =
              "//abstrtact[contains(text(),\"" + TextValue11.getText() +
              "\")]";
          }
          if (KeyWordsCheckBox.isSelected())
          {
            paths[2] =
              "//keyword[contains(text(),\"" + TextValue11.getText() + "\")]";
          }

          if (AllCheckBox.isSelected())
          {
            paths[0] =
              "//*[(contains(text(),\"" + TextValue11.getText() + "\"))]";
            paths[1] = "";
            paths[2] = "";
          }
        }
        ...
        {
          paths[3] =
            "//surName[(contains(text(),\"" + TextValue22.getText() + "\"))]";
        }
        QueryStringTextArea.setText("Query generated on:" +
                                    new Date().toString());
  ...
  String create_XMLQuery()
  {
        ...
        || (TextValue22.getText().length() > 0))
    {
      ...
      if (QueryChoiceTabs.getSelectedIndex() == 0)
      {
        ...
        if ((TextChoices11.isVisible())
            && (TextValue11.getText().length() > 0))
        {
          if (TitleCheckBox.isSelected())
          {
            //pqx.add_queryterm(TextValue11.getText(),
                   //"/eml-dataset/title","contains",true);
            pqx.add_queryterm(TextValue11.getText(), "title", "contains",
                              true);
          }
          if (AbstractCheckBox.isSelected())
          {
            //pqx.add_queryterm(TextValue11.getText(),
                  //"/eml-dataset/abstract/paragraph","contains",true);
            pqx.add_queryterm(TextValue11.getText(), "abstract", "contains",
                              true);
          }
          if (KeyWordsCheckBox.isSelected())
          {
            //pqx.add_queryterm(TextValue11.getText(),
                  //"/eml-dataset/keyword_info/keyword","contains",true);
            pqx.add_queryterm(TextValue11.getText(), "keyword", "contains",
                              true);
          }
          if (AllCheckBox.isSelected())
          {
        ...
        //pqx.end_querygroup();
        if ((TextChoices22.isVisible())
            && (TextValue22.getText().length() > 0))
        {
          pqx.add_querygroup(op);
          pqx.add_queryterm(TextValue22.getText(), "surName", "contains",
                            true);
          //pqx.end_querygroup();
        }
        pqx.end_query();
      ...
      if (QueryChoiceTabs.getSelectedIndex() == 1)
      {
        ...
        {
          pqx.add_queryterm(TextValue1.getText(), "//*",
                            searchmode[TextMatch1.getSelectedIndex()], true);
        }
        if ((TextChoices2.isVisible()) && (TextValue2.getText().length() > 0))
        {
          pqx.add_queryterm(TextValue2.getText(), "//*",
                            searchmode[TextMatch2.getSelectedIndex()], true);
        }
        if ((TextChoices3.isVisible()) && (TextValue3.getText().length() > 0))
        {
          pqx.add_queryterm(TextValue3.getText(), "//*",
                            searchmode[TextMatch3.getSelectedIndex()], true);
        }
        if ((TextChoices4.isVisible()) && (TextValue4.getText().length() > 0))
        {
          pqx.add_queryterm(TextValue4.getText(), "//*",
                            searchmode[TextMatch4.getSelectedIndex()], true);
        }
        if ((TextChoices5.isVisible()) && (TextValue5.getText().length() > 0))
        {
          pqx.add_queryterm(TextValue5.getText(), "//*",
                            searchmode[TextMatch5.getSelectedIndex()], true);
        }
        if ((TextChoices6.isVisible()) && (TextValue6.getText().length() > 0))
        {
          pqx.add_queryterm(TextValue6.getText(), "//*",
                            searchmode[TextMatch6.getSelectedIndex()], true);
        }
        pqx.end_query();
      }
      try
