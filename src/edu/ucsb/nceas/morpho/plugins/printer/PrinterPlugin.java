                                            ...
                                            ServiceProvider
{
    ...
    public void initialize(Morpho morpho)
    {
		...
		private void initializeActions()
		{
				...
				GUIAction pageSetupAction = new GUIAction(/*"Page setup..."*/ Language.getInstance().getMessage("PageSetup") + Language.getInstance().getMessage("..."),
				...
				// Action for preview
				GUIAction previewAction = new GUIAction(/*"Print preview..."*/ Language.getInstance().getMessage("PrintPreview") + Language.getInstance().getMessage("..."),
				...
				// Action for Print
				GUIAction printAction = new GUIAction(/*"Print..."*/ Language.getInstance().getMessage("Print") + Language.getInstance().getMessage("..."),
