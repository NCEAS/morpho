/**
 *  '$RCSfile: AbstractCustomTablePopupHandler.java,v $'
...
/** 
	Class AbstractCustomTablePopupHandler
	
	This class is an abstract class that acts as a dialog and a CustomTablePopupListener
	
*/

public abstract class AbstractCustomTablePopupHandler extends JDialog implements CustomTablePopupListener {
