...
public class TextImportWizardEml2 extends javax.swing.JFrame
{
  ...
  private short dataLocation = WizardSettings.ONLINE;
   ...
   *
   *  @param dataLocation determines how data is stored and referenced:<ul><li>
   *
   ...
   *  </li></ul>
   */
  public TextImportWizardEml2(String dataFileName, 
                              TextImportListener listener, short dataLocation) {
	...
	public static void main(String args[]) {
		new TextImportWizardEml2(args[0], null, WizardSettings.ONLINE).startImport(args[0]);	
	}
	...
	private void parseDelimited() {
		...
		if (lines!=null) {
			...
			for (int k=0;k<numcols;k++) {
				...
				ad = (AttributePage)WizardPageLibrary.getPage(DataPackageWizardInterface.ATTRIBUTE_PAGE);
