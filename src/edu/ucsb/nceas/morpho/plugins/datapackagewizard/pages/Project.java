...
public class Project extends AbstractUIPage {
  ...
  public final String title      = /*"Research Project Information"*/ Language.getInstance().getMessage("Project.title");
  ...
  private final String[] buttonsText = new String[] {
	  ...
	  Language.getInstance().getMessage("Project.SubProject")
  };
  ...
  private final String[] colNames =  {/*"Party"*/ Language.getInstance().getMessage("Party"),
  ...
  private void init() {
    ...
    JLabel desc = WidgetFactory.makeHTMLLabel(
    	...
    	"<b>" + Language.getInstance().getMessage("Party.desc_1") + " ?</b>"
    	/*	
        ...
        */
    	+ Language.getInstance().getMessage("Party.desc_2")
        ,4);
  ...
  private JPanel getDataPanel() {
    ...
    WidgetFactory.addTitledBorder(panel, 
    							  /*"Enter Project Information"*/ Language.getInstance().getMessage("Project.titleDesc")
    							 );
    ...
    JLabel titleDesc = WidgetFactory.makeHTMLLabel(
       "<b>" 
       + /*"Enter the title of the project."*/ Language.getInstance().getMessage("Project.titleDesc") 
       + "</b> "
    	, 1);
    panel.add(titleDesc);
    ...
    JLabel fundingDesc = WidgetFactory.makeHTMLLabel(
      ...
      "<b>" + Language.getInstance().getMessage("Project.fundingDesc_1") + "</b> "
      /*+"This may include agency names and grant or contract numbers."*/
      + Language.getInstance().getMessage("Project.fundingDesc_2")
      , 2);

    panel.add(fundingDesc);
    fundingLabel = WidgetFactory.makeLabel(/*" Funding Source"*/ " " + Language.getInstance().getMessage("FundingSource")
    										, false);
    ...
    JLabel desc = WidgetFactory.makeHTMLLabel(
     ...
     "<b>" + Language.getInstance().getMessage("Project.desc_1") + "</b>"
     /*+"The full name of the people or organizations responsible for the project."*/
     + Language.getInstance().getMessage("Project.desc_2")
      
      , 2);
    panel.add(desc);
    minRequiredLabel = WidgetFactory.makeLabel(
                                /*" One or more Personnel must be defined:"*/ " " + Language.getInstance().getMessage("Project.minRequiredLabel") + ":"
    							, true,
