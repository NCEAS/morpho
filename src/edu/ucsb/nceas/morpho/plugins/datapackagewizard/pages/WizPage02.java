...
public class WizPage02 extends AbstractWizardPage{
  ...
  public final String title      = "Welcome to page 2 of the Data Package Wizard";
  public final String subtitle   = "Please read the instructions below before proceeding";
