...
public class Taxonomic extends AbstractUIPage {
  ...
  private final String heading
      = "<b>Enter information about the Taxonomic Coverage. </b>Provide the "
        +"list of taxa to which the overall set of data applies. Enter the "
        +"taxonomic names and ranks in the table, for up to two taxonomic levels "
        +"for each taxon. To define more levels and/or common names for each "
