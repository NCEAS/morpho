...
public class IntervalRatioPanel extends JPanel implements WizardPageSubPanelAPI {
  ...
  private String[] numberTypesDisplayVals = new String[] {
                        /*"NATURAL "*/ Language.getInstance().getMessage("NATURAL") + " " 
                        +"(" + /*"non-zero counting numbers: 1, 2, 3.."*/ Language.getInstance().getMessage("NATURAL.Desc") + ")",
                                              
                        /*"WHOLE "*/ Language.getInstance().getMessage("WHOLE") + " " 
                        +"(" + /*"counting numbers & zero: 0, 1, 2, 3.."*/ Language.getInstance().getMessage("WHOLE.Desc") + ")",
                        
                        /*"INTEGER "*/ Language.getInstance().getMessage("INTEGER") + " "
                        +"(" + /*"+/- counting nums & zero: -2, -1, 0, 1.."*/ Language.getInstance().getMessage("INTEGER.Desc") + ")",
                        
                        /*"REAL  "*/ /*"NATURAL "*/ Language.getInstance().getMessage("REAL") + " " 
                        +"(" + /*"+/- fractions & non-fractions: -1/2, 3.14.."*/ Language.getInstance().getMessage("REAL.Desc") + ")"
                    };
...
//////////////////////////////////////////////////////
  ...
  private void init() {
    ...
    ////////////////////////
    unitsPickListLabel    = WidgetFactory.makeLabel(/*"Standard Unit:"*/ Language.getInstance().getMessage("StandardUnit") + ":" ,
    ...
    */
    ...
    precisionLabel    = WidgetFactory.makeLabel(/*"Precision:"*/ Language.getInstance().getMessage("Precision") + ":",
    											true, WizardSettings.WIZARD_CONTENT_LABEL_DIMS);
    ...
    precisionGrid.add(this.getLabel(
        ...
        */
        + Language.getInstance().getMessage("IntervalRatioPanel.PrecisionDesc")
    ...
    numberTypeLabel = WidgetFactory.makeLabel(/*"Number Type:"*/ Language.getInstance().getMessage("NumberType") + ":" ,
    											true, WizardSettings.WIZARD_CONTENT_LABEL_DIMS);
    ...
    boundsLabel = WidgetFactory.makeLabel(/*"Bounds:"*/ Language.getInstance().getMessage("Bounds") + ":",
    		false,
    ...
    addButton = new JButton(/*"Add"*/ Language.getInstance().getMessage("Add"));
    ...
    delButton = new JButton(/*"Delete"*/ Language.getInstance().getMessage("Delete"));
...
class UnitsPickList extends JPanel {
  ...
  private final String UNITLIST_DEFAULT  = /*"- Select a Unit Type -"*/ "- " + Language.getInstance().getMessage("SelectUnitType") + " -" ;
  ...
  private void init() {
    ...
    newUnit = new JButton(/*"Define new unit"*/ Language.getInstance().getMessage("DefineNewUnit") );
    newUnit.addActionListener( new ActionListener() {
      ...
      public void actionPerformed(ActionEvent ae) {
        ...
        int dwd = UISettings.POPUPDIALOG_WIDTH - UISettings.DIALOG_SMALLER_THAN_WIZARD_BY;
				...
				customUnitDialog.setTitle(/*"New Unit Definition"*/ Language.getInstance().getMessage("NewUnitDefinition"));
