...
public class PartyPage extends AbstractUIPage {
  ...
  private final String[] checkBoxArray
      = new String[] { 
		  ...
		  Language.getInstance().getMessage("PartyPage.checkBoxArray")
  			};
  ...
  private void init() {
    ...
    JLabel listLabel = WidgetFactory.makeLabel(
        ...
        */
        Language.getInstance().getMessage("PartyPage.listLabel")
        , false);
    ...
    salutationPanel.add(WidgetFactory.makeLabel(/*"Salutation:"*/ Language.getInstance().getMessage("Salutation") +":"
    											, false));
    ...
    firstNamePanel.add(WidgetFactory.makeLabel(/*"First Name:"*/ Language.getInstance().getMessage("FirstName") +":"
    											, false));
    ...
    lastNameLabel = WidgetFactory.makeLabel(/*"Last Name:"*/ Language.getInstance().getMessage("LastName") +":"
    										, true);
    ...
    organizationLabel = WidgetFactory.makeLabel(/*"Organization:"*/ Language.getInstance().getMessage("Organization") +":"
    											, true);
    ...
    positionNameLabel = WidgetFactory.makeLabel(/*"Position Name:"*/ Language.getInstance().getMessage("PositionName") +":"
    											, true);
    ...
    address1Panel.add(WidgetFactory.makeLabel(/*"Address 1:"*/ Language.getInstance().getMessage("Address") +" 1:" 
    											, false));
    ...
    address2Panel.add(WidgetFactory.makeLabel(/*"Address 2:"*/ Language.getInstance().getMessage("Address") +" 2:" 
    											, false));
    ...
    cityStatePanel.add(WidgetFactory.makeLabel(/*"City:"*/ Language.getInstance().getMessage("City") +":" 
    											, false));
    ...
    JLabel stateLabel = WidgetFactory.makeLabel(/*"State:"*/ Language.getInstance().getMessage("State") +":" 
    											, false);
    ...
    zipCountryPanel.add(WidgetFactory.makeLabel(/*"Postal Code:"*/ Language.getInstance().getMessage("PostalCode") +":"
    											, false));
    ...
    JLabel countryLabel = WidgetFactory.makeLabel(/*"Country:"*/ Language.getInstance().getMessage("Country") +":"
    												, false);
    ...
    phoneFaxPanel.add(WidgetFactory.makeLabel(/*"Phone:"*/ Language.getInstance().getMessage("Phone") +":"
    											, false));
    ...
    JLabel faxLabel = WidgetFactory.makeLabel(/*"Fax:"*/ Language.getInstance().getMessage("Fax") +":"
    											, false);
    ...
    emailUrlPanel.add(WidgetFactory.makeLabel(/*"Email:"*/ Language.getInstance().getMessage("Email") +":"
    											, false));
    ...
    JLabel urlLabel = WidgetFactory.makeLabel(/*"Online URL:"*/ Language.getInstance().getMessage("OnlineURL") +":"
    											, false);
    ...
    ItemListener editCheckBoxListener = new ItemListener() {
      ...
      public void itemStateChanged(ItemEvent e) {
        ...
        if (e.getStateChange() == ItemEvent.DESELECTED) {
          ...
          Object[] optionArray
              = new String[] {
                /*"Edit original"*/ Language.getInstance().getMessage("EditOriginal"),
                /*"Copy original and edit"*/ Language.getInstance().getMessage("CopyOriginalAndEdit"),
                /*"Cancel"*/ Language.getInstance().getMessage("Cancel")
                
          		};
          JOptionPane optPane = new JOptionPane();
          optPane.setOptions(optionArray);
          optPane.setMessage(
              /*"Do you want to :\n"*/ Language.getInstance().getMessage("PartyPage.optPane.setMessage_1")
        	  +" :\n"
              /*
              +"Edit the original entry (and therefore change "
              +"all entries that refer to the original), or \n"
              */
        	  + Language.getInstance().getMessage("PartyPage.optPane.setMessage_2")
  ...
  private void initRolePanel() {
    ...
    roleLabel = WidgetFactory.makeLabel(/*"Role:"*/ Language.getInstance().getMessage("Role") + ":"
    									, true);
  }
  ...
  private void setRole(String role) {
    ...
    if (role.equals(DataPackageWizardInterface.PARTY_CREATOR)) {
      ...
      roleString = /*"Contact"*/ Language.getInstance().getMessage("Contact");
      backupXPath = "/contact";
      rolePicklistShouldBeHidden = true;

    } else if (role.equals(DataPackageWizardInterface.PARTY_CITATION_AUTHOR)) {

      roleString = /*"Author"*/ Language.getInstance().getMessage("Author");
      backupXPath = "/creator";
      rolePicklistShouldBeHidden = true;

    } else if (role.equals(DataPackageWizardInterface.PARTY_ASSOCIATED)) {

      roleString = /*"Associated Party"*/ Language.getInstance().getMessage("AssociatedParty");
      backupXPath = "/associatedParty";

    } else if (role.equals(DataPackageWizardInterface.PARTY_PERSONNEL)) {

      roleString = /*"Personnel"*/ Language.getInstance().getMessage("Personnel");
  ...
  public boolean onAdvanceAction() {
    ...
    if (notNullAndNotEmpty(salutationField.getText().trim())
      ...
      if (!lastNameOK) {
        ...
        warningLabel.setText(
        					...
        					+ Language.getInstance().getMessage("PartyPage.warningLabel_1")
        					);
    ...
    if (lastNameOK || organizationOK || positionOK) {
      ...
      warningLabel.setText(
                          ...
                          */
    		              Language.getInstance().getMessage("Warning") + ": "
    		  			  + Language.getInstance().getMessage("PartyPage.warningLabel_2") + ": "
    		  			  + Language.getInstance().getMessage("LastName") + ", "
    		  			  + Language.getInstance().getMessage("PositionName") + ", "
    		  			  + Language.getInstance().getMessage("Or") + " "
    		  			  + Language.getInstance().getMessage("Organization")
                           );
      warningPanel.setVisible(true);
      WidgetFactory.hiliteComponent(warningLabel);
      return false;
