...
TreeSelectionListener, PageChangeListener {
	...
	Action printAction = new AbstractAction("Print...",
			getIcon("/com/sun/pdfview/gfx/print.gif")) {
	...
	ZoomAction zoomInAction = new ZoomAction("Zoom in",
			getIcon("/com/sun/pdfview/gfx/zoomin.gif"), 2.0);
	ZoomAction zoomOutAction = new ZoomAction("Zoom out",
			getIcon("/com/sun/pdfview/gfx/zoomout.gif"), 0.5);
	Action zoomToolAction = new AbstractAction("",
			getIcon("/com/sun/pdfview/gfx/zoom.gif")) {
	...
	Action nextAction = new AbstractAction("Next",
			getIcon("/com/sun/pdfview/gfx/next.gif")) {
	...
	Action firstAction = new AbstractAction("First",
			getIcon("/com/sun/pdfview/gfx/first.gif")) {
	...
	Action lastAction = new AbstractAction("Last",
			getIcon("/com/sun/pdfview/gfx/last.gif")) {
	...
	Action prevAction = new AbstractAction("Prev",
			getIcon("/com/sun/pdfview/gfx/prev.gif")) {
	...
	public static void main(String args[]) {
		...
		for (int i = 0; i < args.length; i++) {
			if (args[i].equalsIgnoreCase("-noThumb")) {
				...
				System.out
				.println("java com.sun.awc.PDFViewer [flags] [file]");
				System.out
				.println("flags: [-noThumb] [-help or -h or -?]");
				System.exit(0);
			} else {
				fileName = args[i];
			}
