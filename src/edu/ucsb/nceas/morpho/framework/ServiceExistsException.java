/**
 *  '$RCSfile: ServiceExistsException.java,v $'
 ...
 * serviceName that has previously been registered.  The service must
 * be re-registered under a different name in order to be utilized.
 */
