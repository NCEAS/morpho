...
public class IdentifierManager
{
  ...
  String scope  = null; 
  long serialNumber = 1;
  private static IdentifierManager manager= null;
  
  /*
   * Private constructor
   */
  private IdentifierManager(ConfigXML profile) throws ConfigurationException
  {
   ...
   * @return
   */
  public static IdentifierManager getInstance(ConfigXML profile) throws ConfigurationException
  {
    if(manager == null)
    {
      manager = new IdentifierManager(profile);
    }
    return manager;
  }
