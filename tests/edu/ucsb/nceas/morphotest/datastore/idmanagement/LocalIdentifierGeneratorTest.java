...
public class LocalIdentifierGeneratorTest extends MorphoTestCase
{
   ...
   */
  public LocalIdentifierGeneratorTest(String name)
  {
      super(name);
  }
  /**
  ...
  public static Test suite()
  {
      ...
      suite.addTest(new LocalIdentifierGeneratorTest("initialize"));
      suite.addTest(new LocalIdentifierGeneratorTest("testGenerateLocalId"));
      return suite;
  }
  ...
  {
    LocalIdentifierGenerator manager = LocalIdentifierGenerator.getInstance(profile);
