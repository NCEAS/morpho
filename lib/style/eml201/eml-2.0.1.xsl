...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:import href="eml-access-2.0.1.xsl"/>
  <xsl:import href="eml-additionalmetadata-2.0.1.xsl"/>
  <xsl:import href="eml-attribute-2.0.1.xsl"/>
  <xsl:import href="eml-attribute-enumeratedDomain-2.0.1.xsl"/>
  <xsl:import href="eml-constraint-2.0.1.xsl"/>
  <xsl:import href="eml-coverage-2.0.1.xsl"/>
  <xsl:import href="eml-dataset-2.0.1.xsl"/>
  <xsl:import href="eml-datatable-2.0.1.xsl"/>
  <xsl:import href="eml-distribution-2.0.1.xsl"/>
  <xsl:import href="eml-entity-2.0.1.xsl"/>
  <xsl:import href="eml-identifier-2.0.1.xsl"/>
  <xsl:import href="eml-literature-2.0.1.xsl"/>
  <xsl:import href="eml-method-2.0.1.xsl"/>
  <xsl:import href="eml-otherentity-2.0.1.xsl"/>
  <xsl:import href="eml-party-2.0.1.xsl"/>
  <xsl:import href="eml-physical-2.0.1.xsl"/>
  <xsl:import href="eml-project-2.0.1.xsl"/>
  <xsl:import href="eml-protocol-2.0.1.xsl"/>
  <xsl:import href="eml-resource-2.0.1.xsl"/>
  <xsl:import href="eml-settings-2.0.1.xsl"/>
  <xsl:import href="eml-software-2.0.1.xsl"/>
  <xsl:import href="eml-spatialraster-2.0.1.xsl"/>
  <xsl:import href="eml-spatialvector-2.0.1.xsl"/>
  <xsl:import href="eml-storedprocedure-2.0.1.xsl"/>
  <xsl:import href="eml-text-2.0.1.xsl"/>
  <xsl:import href="eml-view-2.0.1.xsl"/>
